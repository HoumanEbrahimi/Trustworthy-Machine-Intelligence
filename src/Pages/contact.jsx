    ...
    return(
        ...
        <div className="contain">
            ...
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfM3FLyjZFq8Ue2Bi2DEZZXnpUX-e-5TTrvR2-dpZqEilitvg/viewform">
                ...
                <FontAwesomeIcon  icon={faPodcast} size="6x" transform="left-70 down-15" color='rgb(30,48,80)'/>
            </a>
                <div className="icon-inline move-right" >Check out our latest podcast</div>

                <FontAwesomeIcon  icon={faAddressCard} size="6x" transform="left-69 down-35" color='rgb(30,48,80)'/>
                <div className="icon-inline2 move-right2" >Become a member</div>

                
                <FontAwesomeIcon  icon={faEnvelope} size="6x" transform="left-69 down-35" color='rgb(30,48,80)'/>
